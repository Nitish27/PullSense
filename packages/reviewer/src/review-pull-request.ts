...
export function buildReviewPrompt(input: PullRequestReviewInput) {
	...
	return [
		...
		"- Only report an issue when the diff itself provides enough evidence of a concrete risk or bug.",
		...
		"- If a concern depends on hidden files, missing deployment context, or assumptions about follow-up changes, leave it out.",
		...
		"- Do not create inlineFindings for broad architectural concerns, speculative regressions, or follow-up suggestions that are not tied to a specific changed line.",
